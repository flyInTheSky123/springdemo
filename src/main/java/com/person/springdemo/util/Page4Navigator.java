package com.person.springdemo.util;
import java.util.List;
import org.springframework.data.domain.Page;

/*使用page4navigator 代替 替换 原本分页查询要返回的 org.springframework.data.domain.Page 类。
 原因是 Page 类对json 还原不支持，在放如 Redis 之后，再拿出来，就会报错失败。
 */
